...
RSpec.describe AgentHarness::Providers::GithubCopilot do
  ...
  describe "instance" do
    ...
    describe "#build_command" do
      ...
      it "includes --allow-all-tools only in dangerous_mode" do
    ...
    describe "#send_message" do
      ...
      it "sends prompt in non-interactive mode with JSON output" do
        ...
        expect(mock_executor).to receive(:execute).with(
          ["github-copilot-cli", "-p", "Hello", "-s", "--output-format", "json"],
          anything
        )
      ...
      context "with dangerous_mode" do
        it "includes --allow-all-tools in the command" do
          ...
          expect(mock_executor).to receive(:execute).with(
            ["github-copilot-cli", "-p", "Hello", "-s", "--output-format", "json", "--allow-all-tools"],
            anything
          )
