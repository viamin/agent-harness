...
* expose schema-constrained API responses with preserved JSON text, locally validated parsed values, and explicit refusal, truncation, invalid JSON, schema mismatch, and unsupported-mode outcomes ([#434](https://github.com/viamin/agent-harness/issues/434)).
...
* **deps-dev:** bump @anthropic-ai/claude-code from 2.1.268 to 2.1.275 in /vendor/pins/claude ([#419](https://github.com/viamin/agent-harness/issues/419)) ([cdb0fde](https://github.com/viamin/agent-harness/commit/cdb0fdef7239ba4ecd70eaea566b46c4abb81a6e))

## [0.37.3](https://github.com/viamin/agent-harness/compare/agent-harness/v0.37.2...agent-harness/v0.37.3) (2026-09-20)


### Bug Fixes

* **deps-dev:** bump opencode-ai from 1.18.30 to 1.18.31 in /vendor/pins/opencode ([#421](https://github.com/viamin/agent-harness/issues/421)) ([c0b5141](https://github.com/viamin/agent-harness/commit/c0b5141d68a5953de6555616135203f874843cad))

## [0.37.2](https://github.com/viamin/agent-harness/compare/agent-harness/v0.37.1...agent-harness/v0.37.2) (2026-09-20)


### Bug Fixes

* **deps-dev:** bump @oh-my-pi/pi-coding-agent from 18.1.17 to 18.2.4 in /vendor/pins/omp ([#418](https://github.com/viamin/agent-harness/issues/418)) ([f11c178](https://github.com/viamin/agent-harness/commit/f11c178482c348ddff7ada299c89e7faefb85198))

## [0.37.1](https://github.com/viamin/agent-harness/compare/agent-harness/v0.37.0...agent-harness/v0.37.1) (2026-09-20)


### Bug Fixes

* **deps-dev:** bump @kilocode/cli from 7.6.2 to 7.7.3 in /vendor/pins/kilocode ([#420](https://github.com/viamin/agent-harness/issues/420)) ([80586bf](https://github.com/viamin/agent-harness/commit/80586bf54a4fcdb0e1052478d2d34497005f2365))
...
* label cursor pin refresh PRs as paid automation ([#411](https://github.com/viamin/agent-harness/issues/411)) ([6232368](https://github.com/viamin/agent-harness/commit/62323688113d8a3e210316a781bae995042758ed))

## [0.36.23](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.22...agent-harness/v0.36.23) (2026-09-13)


### Bug Fixes

* **deps-dev:** bump bun from 1.4.0 to 1.4.2 in /vendor/pins/omp ([#400](https://github.com/viamin/agent-harness/issues/400)) ([c7ae28c](https://github.com/viamin/agent-harness/commit/c7ae28c8fbe57b89c485bde5ea287fc90f0f7dc3))
...
* **deps-dev:** bump simplecov in the minor-updates group ([#396](https://github.com/viamin/agent-harness/issues/396)) ([89a662c](https://github.com/viamin/agent-harness/commit/89a662ce13ec1bfd14d345e4d4955d4c74a7653c))

## [0.36.17](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.16...agent-harness/v0.36.17) (2026-09-07)


### Bug Fixes

* **deps-dev:** bump @oh-my-pi/pi-coding-agent from 18.0.8 to 18.1.6 in /vendor/pins/omp ([#389](https://github.com/viamin/agent-harness/issues/389)) ([7410000](https://github.com/viamin/agent-harness/commit/7410000ff3ec4ac68646ceb96949ddd7259c7957))

## [0.36.16](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.15...agent-harness/v0.36.16) (2026-09-07)


### Bug Fixes

* **deps-dev:** bump @kilocode/cli from 7.5.5 to 7.5.9 in /vendor/pins/kilocode ([#387](https://github.com/viamin/agent-harness/issues/387)) ([bdada44](https://github.com/viamin/agent-harness/commit/bdada44c5fdc04b62d7cc53b07df47ee8cdcb0d0))

## [0.36.15](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.14...agent-harness/v0.36.15) (2026-09-07)


### Bug Fixes

* **deps-dev:** bump opencode-ai from 1.18.23 to 1.18.27 in /vendor/pins/opencode ([#390](https://github.com/viamin/agent-harness/issues/390)) ([12e107e](https://github.com/viamin/agent-harness/commit/12e107ea0d38124dc2c559f3a4f2d1c5878d7049))

## [0.36.14](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.13...agent-harness/v0.36.14) (2026-09-07)


### Bug Fixes

* **deps-dev:** bump @anthropic-ai/claude-code from 2.1.250 to 2.1.260 in /vendor/pins/claude ([#388](https://github.com/viamin/agent-harness/issues/388)) ([9988142](https://github.com/viamin/agent-harness/commit/99881425dccca0a4b6b122b9653710d2634bde51))
...
* **deps-dev:** bump @kilocode/cli from 7.4.23 to 7.5.5 in /vendor/pins/kilocode ([#375](https://github.com/viamin/agent-harness/issues/375)) ([82e8a0d](https://github.com/viamin/agent-harness/commit/82e8a0d244930f643f16e8381619ca31ad9eb61c))

## [0.36.10](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.9...agent-harness/v0.36.10) (2026-08-31)


### Bug Fixes

* **deps-dev:** bump opencode-ai from 1.18.19 to 1.18.23 in /vendor/pins/opencode ([#378](https://github.com/viamin/agent-harness/issues/378)) ([c818762](https://github.com/viamin/agent-harness/commit/c818762879967e497c744a07d7ee4c4affb1502c))

## [0.36.9](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.8...agent-harness/v0.36.9) (2026-08-31)


### Bug Fixes

* **deps-dev:** bump @anthropic-ai/claude-code from 2.1.238 to 2.1.250 in /vendor/pins/claude ([#376](https://github.com/viamin/agent-harness/issues/376)) ([c3de0e4](https://github.com/viamin/agent-harness/commit/c3de0e42c66133ec1caa316c84ad08183793ec93))
...
* Codex 0.122.0 cannot decode model catalogs containing the max reasoning level ([#370](https://github.com/viamin/agent-harness/issues/370)) ([a49fd37](https://github.com/viamin/agent-harness/commit/a49fd3776ff834f8dbbaf10852d46c247b435f85))
...
* **deps-dev:** bump @kilocode/cli from 7.4.22 to 7.4.23 in /vendor/pins/kilocode ([#359](https://github.com/viamin/agent-harness/issues/359)) ([91fc3d8](https://github.com/viamin/agent-harness/commit/91fc3d8695b246e88c3ae72740dbd8e32f4523ae))

## [0.36.3](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.2...agent-harness/v0.36.3) (2026-08-23)


### Bug Fixes

* **deps-dev:** bump opencode-ai from 1.18.18 to 1.18.19 in /vendor/pins/opencode ([#357](https://github.com/viamin/agent-harness/issues/357)) ([7e072e8](https://github.com/viamin/agent-harness/commit/7e072e8ec2a5373a12aa83b3891a904ce55d1bd8))

## [0.36.2](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.1...agent-harness/v0.36.2) (2026-08-23)


### Bug Fixes

* **deps-dev:** bump bun from 1.3.14 to 1.4.0 in /vendor/pins/omp ([#356](https://github.com/viamin/agent-harness/issues/356)) ([ea29695](https://github.com/viamin/agent-harness/commit/ea29695951a44192b1f6f9bb50f942892afacf81))

## [0.36.1](https://github.com/viamin/agent-harness/compare/agent-harness/v0.36.0...agent-harness/v0.36.1) (2026-08-23)


### Bug Fixes

* **deps-dev:** bump @anthropic-ai/claude-code from 2.1.233 to 2.1.238 in /vendor/pins/claude ([#355](https://github.com/viamin/agent-harness/issues/355)) ([87701e0](https://github.com/viamin/agent-harness/commit/87701e0459aa13b271ed9103b01c94fd98a1905d))
