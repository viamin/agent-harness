...
```ruby
contract = AgentHarness.provider_installation_contract(:kilocode, version: "7.4.23")
...
#      version: "1.18.23",
#      version_requirement: [">= 1.18.23", "< 2.0.0"],
#      binary_name: "opencode",
#      install_command: ["npm", "install", "-g", "--ignore-scripts", "opencode-ai@1.18.23"]
#    }
